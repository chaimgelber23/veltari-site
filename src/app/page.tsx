  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden hero-gradient">
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center pt-24 pb-20">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border bg-card/80 backdrop-blur-sm mb-8 animate-fade-in">
        ...
        {/* Headline */}
        <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl xl:text-8xl leading-[1.05] tracking-tight mb-6 animate-fade-in-up">
          Your Custom Website.
          <br />
          <span className="text-gradient">Live in 24 Hours.</span>
        </h1>
        ...
        {/* Social proof line */}
        <div
          className="flex items-center justify-center gap-6 mt-14 text-sm text-muted animate-fade-in"
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {problems.map((p, i) => (
            <div
              key={i}
              className="group p-8 rounded-2xl border border-border bg-card hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5 transition-all duration-300 hover:-translate-y-1"
            >
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`relative rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 ${
                plan.popular
                  ? "bg-primary text-surface border-2 border-accent shadow-2xl shadow-accent/10 scale-[1.02]"
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          {projects.map((project) => (
            <div
              key={project.name}
              className="group rounded-2xl overflow-hidden border border-border bg-card hover:border-accent/30 hover:shadow-xl transition-all duration-500 hover:-translate-y-1"
            >
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {badges.map((b, i) => (
            <div
              key={i}
              className="text-center p-8 rounded-2xl border border-border bg-card hover:border-accent/30 hover:shadow-lg transition-all duration-300 group"
            >
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <details
              key={i}
              className="group rounded-2xl border border-border bg-card overflow-hidden transition-all duration-300 hover:border-accent/30"
            >
